...
const variants: Record<SurfaceVariant, string> = {
  ...
  interactive: 'border-usnee-border bg-usnee-glass shadow-card transition-[transform,border-color,background-color] duration-normal ease-ui hover:border-usnee-borderStrong hover:bg-usnee-glassStrong active:scale-[.985] motion-reduce:transform-none',
