...
> Канонические архитектурные решения зафиксированы в `docs/adr/` (приватная карта локальных версий и архивов из репозитория исключена намеренно).
...
1. **Запись инъекций**
   ...
   - Quick Record — основной быстрый путь (1 тап, без review-шага);
   - AdvancedRecordForm — мёртвый код (1020 строк, не в роутах), оставить до Phase 5;
   - RecordSummary — используется History.tsx, оставить;
